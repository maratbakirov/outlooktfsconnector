...
// 3. Assign attributes to the control tags in the Ribbon XML file to identify the
// appropriate callback methods in your code.  
...
namespace OutlookTfsConnector
{
    ...
    public class Ribbon : Office.IRibbonExtensibility
    {
        ...
        {
            return GetResourceText("OutlookTfsConnector.Ribbon.xml");
        }
        ...
        public void Ribbon_Load(Office.IRibbonUI ribbonUI)
        {
            ...
            this.outlookApp = Globals.ThisAddIn.Application as Microsoft.Office.Interop.Outlook.Application;
            this.outlookAddin = Globals.ThisAddIn;
        }

        public void btnAddEmailToTfs_Click(IRibbonControl control)
        {
        ...
        public void btnAddEmailToTfsNewEmail_Click(IRibbonControl control)
        {
            var context = control.Context;
            var mailItem = null as MailItem;
        ...
        public Bitmap getTfsImage(IRibbonControl control)
        {
            return Resources.TfsImage;
        }
