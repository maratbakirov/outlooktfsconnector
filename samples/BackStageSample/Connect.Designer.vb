...
Partial Public NotInheritable Class Connect
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Word.ApplicationFactory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "AddIn", "BackStageSample")
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Connect As Connect
    ...
    Friend Shared Property Connect() As Connect
        Get
            Return _Connect
        End Get
        Set
            If (_Connect Is Nothing) Then
                _Connect = value
            Else
